...
export async function POST(req: Request) {
    try {
        ...
        const system_instruction_arr = [
            ...
            "- image_prompt: Write a photographic formula for 100% human-like realism. Every image MUST be a FULL LENGTH BODY PORTRAIT showing the person from HEAD TO TOE. The subject MUST be STANDING and wearing SHARP SHOES (e.g., boots, heels, sneakers) that match the outfit. Absolutely NO bare feet or cropped-off feet. [Subject description], mirror selfie in a residential interior, candid snapshot, shot on smartphone, amateur lighting, unpolished, raw photo.",
            ...
            "- FULL BODY OUTFITS ONLY: If the topic is fashion or outfits, EVERY single image prompt MUST explicitly describe a FULL BODY portrait of a person standing or walking, wearing the complete outfit INCLUDING SHOES. NEVER generate an image of just a bag, watch, shoes, or a half-body crop. Head to toe only.",
